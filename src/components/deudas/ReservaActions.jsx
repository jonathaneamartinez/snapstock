...
/**
 * Botones "✓ Cobrar" y "✕ Liberar" con popover de confirmación.
 * Props:
...
export default function ReservaActions({ inventoryId, buyerName, onDone }) {
  ...
  const toggle = (which) =>
    setConfirm(prev => (prev === which ? null : which))

  return (
    <div ref={popoverRef} className="relative flex gap-1 items-center">
      <button
